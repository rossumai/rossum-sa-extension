...
- **MDH side panel** — opens the "Matching provenance" debugger (MDH hooks and lookup fields) in Chrome's side panel, where it stays put while you scroll and click through the annotation screen (the popup version closes as soon as you click away)
...
- **Onboarding training** — a guided, gamified track for new partners: missions
  ...
  default. The extension never writes to your organization.
