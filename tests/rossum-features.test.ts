...
describe('resource-ids', () => {
  ...
  it('displays ID for sidebar queue (data-id attribute)', () => {
    ...
    const badge = el.querySelector<HTMLElement>('.rossum-sa-extension-resource-id')!;
    expect(badge).not.toBeNull();
