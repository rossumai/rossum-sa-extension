...
describe('BulkConfirm', () => {
  it('one-click mode: enables submit immediately for counts 1–10', () => {
    ...
    const submit = root.querySelector<HTMLButtonElement>('[data-testid="bulk-submit"]')!;
  ...
  it('count-gate mode: disables submit until typed value matches the count exactly', () => {
    ...
    input.value = '423';
    input.dispatchEvent(new Event('input', { bubbles: true }));
    expect(root.querySelector<HTMLButtonElement>('[data-testid="bulk-submit"]')!.disabled).toBe(false);
  });
  ...
  it('count-gate mode: rejects values with commas, decimals, or non-digits', () => {
    ...
    const input = root.querySelector<HTMLInputElement>('[data-testid="bulk-confirm-input"]')!;
    const get = () => root.querySelector<HTMLButtonElement>('[data-testid="bulk-submit"]')!.disabled;
  ...
  it('Cancel button calls onCancel', () => {
    ...
    root.querySelector<HTMLElement>('[data-testid="bulk-cancel"]')!.click();
