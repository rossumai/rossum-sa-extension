...
describe('field discovery', () => {
  ...
  it('truncates to MAX_FIELDS', () => {
    const doc = {};
    for (let i = 0; i < 60; i++) (doc as any)[`field_${String(i).padStart(3, '0')}`] = i;
...
describe('pipeline builders', () => {
  ...
  it('buildValueDistributionPipeline limits to TOP_VALUES', () => {
    ...
    const limitStage = stages.find((s: any) => s.$limit);
