...
export const ENDPOINTS = [
  {
    collection: 'queues',
    kind: 'list',
    pathTemplate: '/api/v1/queues',
    label: 'Queues',
    description: 'list · filters: workspace · ordering · page_size',
  },
  {
    collection: 'queues',
    kind: 'detail',
    pathTemplate: '/api/v1/queues/{id}',
    label: 'Queue',
    description: 'one queue · fields: schema, hooks, inbox, engine, workspace',
  },
  {
    collection: 'schemas',
    kind: 'list',
    pathTemplate: '/api/v1/schemas',
    label: 'Schemas',
    description: 'list · ordering · page_size',
  },
  {
    collection: 'schemas',
    kind: 'detail',
    pathTemplate: '/api/v1/schemas/{id}',
    label: 'Schema',
    description: 'one schema (content tree)',
  },
  {
    collection: 'hooks',
    kind: 'list',
    ...
    label: 'Hooks',
    description: 'list · filters: active, queue · page_size',
  },
  {
    collection: 'hooks',
    kind: 'detail',
    ...
    label: 'Hook',
    description: 'one hook/extension',
  },
  {
    collection: 'hooks',
    kind: 'sub',
    pathTemplate: '/api/v1/hooks/logs',
    label: 'Hook logs',
    description: 'hook execution logs · filters: hook, log_level',
  },
  {
    collection: 'engines',
    kind: 'list',
    ...
    label: 'Engines',
    description: 'list of extraction engines',
  },
  {
    collection: 'engines',
    kind: 'detail',
    pathTemplate: '/api/v1/engines/{id}',
    label: 'Engine',
    description: 'one engine',
  },
  {
    collection: 'rules',
    kind: 'list',
    pathTemplate: '/api/v1/rules',
    label: 'Rules',
    description: 'list · filters: queue, enabled',
  },
  {
    collection: 'rules',
    kind: 'detail',
    pathTemplate: '/api/v1/rules/{id}',
    label: 'Rule',
  ...
  },
  {
    ...
    kind: 'list',
    pathTemplate: '/api/v1/annotations',
    label: 'Annotations',
    description:
      'list · filters: queue, status, document, id · sideload: document, modifier · ordering',
  },
  {
    collection: 'annotations',
    kind: 'detail',
    pathTemplate: '/api/v1/annotations/{id}',
    label: 'Annotation',
    description: 'one annotation · sideload: document, modifier',
  },
  {
    collection: 'annotations',
    kind: 'sub',
    pathTemplate: '/api/v1/annotations/{id}/content',
    label: 'Annotation content',
    description: 'datapoint tree (read-only here)',
  },
  {
  ...
  },
  {
    collection: 'documents',
    kind: 'sub',
    pathTemplate: '/api/v1/documents/{id}/content',
  ...
  },
  {
    collection: 'pages',
    kind: 'detail',
    pathTemplate: '/api/v1/pages/{id}',
    label: 'Page',
    description: 'one page · page_data?granularity=words',
  },
  {
    ...
    label: 'Relations',
    description: 'annotation relations',
  },
  {
    ...
    label: 'Workspaces',
    description: 'list · filters: organization',
  },
  {
    collection: 'workspaces',
    kind: 'detail',
    pathTemplate: '/api/v1/workspaces/{id}',
    label: 'Workspace',
  ...
  },
  {
    ...
    label: 'Users',
    description: 'list · filters: username, email, is_active',
  },
  {
    collection: 'users',
    kind: 'detail',
  ...
  },
  {
    ...
    kind: 'list',
    pathTemplate: '/api/v1/email_templates',
    label: 'Email templates',
    description: 'list · filters: queue',
  },
  {
    collection: 'emails',
    kind: 'list',
    pathTemplate: '/api/v1/emails',
    label: 'Emails',
    description: 'list · filters: queue, thread',
  },
  {
    collection: 'email_threads',
    kind: 'list',
    pathTemplate: '/api/v1/email_threads',
    label: 'Email threads',
    description: 'list · filters: queue',
  },
  {
    collection: 'inboxes',
    kind: 'detail',
    pathTemplate: '/api/v1/inboxes/{id}',
    label: 'Inbox',
  ...
  },
  {
    ...
    kind: 'list',
    pathTemplate: '/api/v1/workflow_steps',
    label: 'Workflow steps',
    description: 'ordered steps · filter: workflow',
  },
  {
    collection: 'workflow_runs',
    kind: 'list',
    pathTemplate: '/api/v1/workflow_runs',
    label: 'Workflow runs',
    description: 'runs · filters: annotation, status',
  },
  {
    collection: 'workflow_activities',
    kind: 'list',
    pathTemplate: '/api/v1/workflow_activities',
    label: 'Workflow activities',
    description: 'assignee activity · filter: workflow_run',
  },
  {
    collection: 'audit_logs',
    kind: 'list',
    pathTemplate: '/api/v1/audit_logs',
    label: 'Audit logs',
    description: 'cursor pagination · filters: user, action, object',
  },
  {
    collection: 'tasks',
    kind: 'detail',
  ...
  },
  {
    collection: 'auth',
    kind: 'sub',
    pathTemplate: '/api/v1/auth/user',
    label: 'Auth user',
    description: 'the current user + home org',
  },
];
