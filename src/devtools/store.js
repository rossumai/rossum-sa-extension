...
function blankTab(id, source, resource) {
...
export function patchTab(id, patch) { tabs.value = tabs.value.map((t) => (t.id === id ? { ...t, ...patch } : t)); }
export function setActive(id) { linkMenu.value = null; tabMenu.value = null; activeId.value = id; }
...
export function openTab(resource, source = 'link') {
...
export function syncPageTab(resource) {
...
export function moveTab(dragId, dropId) {
