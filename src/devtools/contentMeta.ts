...
const EXT = {
  'application/pdf': 'pdf', 'image/png': 'png', 'image/jpeg': 'jpg', 'image/svg+xml': 'svg', 'image/gif': 'gif', 'image/webp': 'webp',
  'application/msword': 'doc', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document': 'docx',
  'application/vnd.ms-excel': 'xls', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet': 'xlsx',
  'text/csv': 'csv', 'text/plain': 'txt', 'application/zip': 'zip', 'application/xml': 'xml', 'text/xml': 'xml',
};
...
export function filenameFrom(
  contentDisposition?: string | null, apiPath?: string | null, contentType?: string | null,
): string {
