...
const ROUTES = [
  ...
  { type: 'rule',   re: /\/queues\/\d+\/settings\/rules\/(\d+)\/detail(?:[/?#]|$)/, api: (id: string) => `/api/v1/rules/${id}`, label: 'Rule' },
  { type: 'queue',  re: /\/queues\/(\d+)(?:[/?#]|$)/,                    api: (id: string) => `/api/v1/queues/${id}`, label: 'Queue' },
  { type: 'hook',   re: /\/extensions\/my-extensions\/(\d+)(?:[/?#]|$)/, api: (id: string) => `/api/v1/hooks/${id}`, label: 'Hook' },
  { type: 'user',   re: /\/settings\/users\/(\d+)(?:[/?#]|$)/,          api: (id: string) => `/api/v1/users/${id}`, label: 'User' },
  ...
  { type: 'schema', re: /\/settings\/field-manager\/detail\/(\d+)(?:[/?#]|$)/, api: (id: string) => `/api/v1/schemas/${id}`, label: 'Schema' },
  { type: 'engine', re: /\/automation\/engines\/(\d+)(?:[/?#]|$)/,      api: (id: string) => `/api/v1/engines/${id}`, label: 'Engine' },
  ...
  { type: 'annotation', re: ANNOTATION_PATH_RE, api: (id: string) => `/api/v1/annotations/${id}`, label: 'Annotation' },
];
