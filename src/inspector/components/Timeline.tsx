...
function gap(a: any, b: any) {
  // Erased casts, not unary `+`: subtraction already coerces via valueOf, and adding the
  // operator would change the emitted expression.
  const ms = (new Date(b) as any) - (new Date(a) as any);
