...
export function tweenAt(from: number, to: number, elapsed: number, duration = SCROLL_MS) {
...
/** null means "already visible — leave the editor alone". */
export function revealScrollTop(line: any, view: any): number | null {
