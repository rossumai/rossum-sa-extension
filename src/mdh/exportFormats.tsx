...
function formatJsonDoc(doc: any) {
...
function CsvControls({ opts, setOpt }: ControlsProps) {
  return (
    <Fragment>
...
function XlsxControls({ opts, setOpt }: ControlsProps) {
  return (
    <Fragment>
      <span class="csv-tb-item">
...
function XmlControls({ opts, setOpt }: ControlsProps) {
  return (
    <Fragment>
      <span class="csv-tb-item">
...
export function getExportFormat(id: any) {
  return EXPORT_FORMATS.find((f) => f.id === id);
}

export function exportFilename(collection: any, scope: any, fmt: any) {
...
export function buildExportJob(config: any, collection: any, stages: any) {
