...
export function isCompatibleWithType(val: unknown, type?: string): boolean {
...
export function valueBasedType(val: unknown): string {
...
export function typeOptionsFor(value: unknown, override?: string) {
  const v = value || '';
...
async function fetchAnnotationFields(annotId: any) {
...
function extractDatapoints(nodes: any, fields: any) {
...
export default function PlaceholderInputs({ names, values, types, onSetValue, onSetType, onRunQuery, resolvedTypeFor }: {
  ...
  onSetType: (name: string, type: string | undefined) => void;
  onRunQuery: () => void;
  resolvedTypeFor: (name: string) => any;
}) {
