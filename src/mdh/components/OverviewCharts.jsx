...
const SCALE_LABEL = { linear: 'Linear', sqrt: '√', log: 'log' };
const SCALE_TITLE = {
...
const SCALE_AXIS_LABEL = { linear: 'linear', sqrt: '√ scale', log: 'log–log' };
...
export default function OverviewCharts({ rows, settled, onOpen }) {
  ...
  const scatter = anyScatter
    ...
    : { points: [], xTicks: [], yTicks: [], plot: null };
