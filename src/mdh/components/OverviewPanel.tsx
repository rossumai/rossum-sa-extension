...
async function runWithConcurrency(items: any, concurrency: any, signal: any, worker: any) {
  let idx = 0;
...
export default function OverviewPanel() {
  ...
  async function streamStats(names: any, signal: any, publish: any, { useCache }: { useCache?: boolean }) {
    ...
    function cacheAndRecord(name: any, res: any) {
    ...
    async function fetchOne(name: any) {
      try {
  ...
  function makePublisher(controller: any, withLoadingSet: any) {
    ...
    return function publish(name: any, value: any) {
  ...
  function barPct(value: any, max: any) {
  ...
  function openCollection(name: any) {
