...
export function getEjsonType(value: unknown): string | null {
...
export function formatEjsonValue(value: any, typeKey: string): string {
...
export function copyTextFor(v: unknown): string {
  if (v === null) return 'null';
