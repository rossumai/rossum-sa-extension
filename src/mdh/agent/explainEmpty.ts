...
export function firstEmptyStage(
  previews: Record<number, { docs?: unknown[]; error?: unknown }> | null | undefined,
  activeCount: number,
): number {
...
export function cachedExplanation(signature: string | null | undefined) {
...
export function buildEmptyStagePrompt({
  ...
  stages: any[];
  rawStages?: any[] | null;
  variables?: { name: string; value: unknown; type?: string; isSet?: boolean }[] | null;
  emptyIndex: number;
  counts?: unknown[];
