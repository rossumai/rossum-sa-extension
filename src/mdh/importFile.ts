...
export function stableKey(id: unknown): string {
  ...
  if (t === 'bigint') return 'i:' + (id as bigint).toString();
...
export function normalizeDocId(doc: any): any {
...
export function dedupeById(docs: any[]) {
