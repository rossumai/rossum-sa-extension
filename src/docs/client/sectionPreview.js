...
export function initSectionPreview(root, scroller, opts) {
  var options = opts || {};
  ...
  function populate(c, parts, href, from) {
    ...
    var fromEl = c.querySelector('.section-preview-from');
    if (from) {
    ...
    var jump = c.querySelector('.section-preview-jump');
