...
export function createScene(container: HTMLElement) {
  ...
  let linkGeom: any = null, linkLines: any = null, baseLinkColors: any = null;
  let sim: any = null;
  type NodeCb = (id: string | null) => void;
  let hoverCb: NodeCb = () => {}, clickCb: NodeCb = () => {};
  let raf: any = null, idleTimer: any = null;
  ...
  function onDown(ev: any) { downX = ev.clientX; downY = ev.clientY; }
  ...
  return {
    setData,
    onHover(cb: (id: string | null) => void) { hoverCb = cb || (() => {}); },
    onClick(cb: (id: string | null) => void) { clickCb = cb || (() => {}); },
    focus(id: string | null) { focusOn(id); },
    setIdleSpin(on: boolean) { controls.autoRotate = !!on; },
