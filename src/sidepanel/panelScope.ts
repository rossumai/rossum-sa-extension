...
export function panelOptionsFor(tabId: number, url?: string | null) {
...
export function panelUpdateFor(tabId: number, changeInfo: any, tab: any) {
...
export async function openPanelForTab(tabId: number, api: any) {
