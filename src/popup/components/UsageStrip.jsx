...
export function stripVisible({ consent, reviewing }) {
  return consent === null || reviewing === true;
}

export default function UsageStrip({ consent, reviewing, onAnswer }) {
...
// back out.
export function UsageFooterButton({ asked, consent, onToggle }) {
